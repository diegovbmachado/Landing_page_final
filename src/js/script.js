...
var galleryData = [
    {
        ...
        description: 'Detalhes da tattoo com acabamento preciso e suave no contorno.'
    },
    {
        src: 'https://images.unsplash.com/photo-1524504388940-b1c1722653e1?auto=format&fit=crop&w=1200&q=80',
        alt: 'Tatuagem no ombro',
        title: 'Sombreamento suave',
        description: 'Tatuagens que ganham profundidade natural com sombreados bem trabalhados.'
    },
    {
        src: 'https://images.unsplash.com/photo-1511988617509-a57c8a288659?auto=format&fit=crop&w=1200&q=80',
        alt: 'Tatuagem na mão',
        title: 'Estilo autoral',
        description: 'Peças únicas feitas para combinar com a personalidade de cada cliente.'
    },
    {
        ...
        description: 'Tatuagens com contraste e estilo, perfeitas para quem quer causar impacto.'
    },
    {
        src: 'https://images.unsplash.com/photo-1545239351-1141bd82e8a6?auto=format&fit=crop&w=1200&q=80',
        alt: 'Tatuagem de flores',
        title: 'Floral elegante',
        description: 'Traços suaves e orgânicos para uma tatuagem feminina e sofisticada.'
    },
    {
        src: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&w=1200&q=80',
        alt: 'Tatuagem geométrica',
        title: 'Geométrico moderno',
        description: 'Linhas e formas precisas que criam um efeito visual marcante.'
    },
    {
...
var galleryMainDescription = document.getElementById('gallery-main-description');
...
function renderGallery() {
    ...
    galleryThumbnails.innerHTML = galleryData
        .map(function(item, index) {
            ...
            return "<button type=\"button\" data-index=\"" + index + "\" class=\"shrink-0 rounded-3xl overflow-hidden border transition-shadow duration-200 focus:outline-none "+ (isActive ? 'ring-2 ring-blue-500 shadow-lg' : 'border-gray-200 dark:border-gray-700') + "\">" +
                "<img src=\"" + item.src + "\" alt=\"" + item.alt + "\" class=\"h-24 w-24 object-cover sm:h-28 sm:w-28\" />" +
                "</button>";
        })
        .join('');
    ...
    if (galleryNext) galleryNext.disabled = activeIndex === galleryData.length - 1;
    if (thumbPrev) thumbPrev.disabled = thumbStart === 0;
    if (thumbNext) thumbNext.disabled = thumbStart + THUMB_VISIBLE >= galleryData.length;
}
